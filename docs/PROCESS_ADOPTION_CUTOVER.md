...
1. Merge the policy bridge while every engineering-process rule remains disabled and
   the global command allowlist remains empty. Resolve the exact resulting commit on
   protected main.
